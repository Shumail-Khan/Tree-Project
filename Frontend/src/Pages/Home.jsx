...
const Home = () => {
  ...
  return (
    <>
      ...
      <VapiWidget
        publicKey="07dcfa07-57a9-4307-b416-e5afa36dd4b0"
        assistantId="1cd97924-6534-40cf-b557-0324b9bbe392"
        mode="voice"
        theme="dark"
        baseBgColor="#000000"
        accentColor="#67ff69" 
        ctaButtonColor="#fffdfd"
        ctaButtonTextColor="#0bcc6b"
        borderRadius="medium" 
        size="compact"
        position="bottom-right"
        title="Tree Service Information" 
